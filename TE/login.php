...
if (isset($_POST['login'])) {
	if (isset($_POST['username']) && isset($_POST['password'])) {
		...
		$num = 0;
		$result = mysqli_query($conn,"SELECT * FROM user WHERE (username='$user_login') AND password='$password_login'");
...
?>
	...
	<body>
	    <div class="homepageheader">
		    ...
		    <a style="text-decoration: none; color: #ffffff;" href="signin.php">REGISTER</a>
    	</div>
	    <div class="uiloginbutton signinButton loginButton" style="">
	        <a style="text-decoration: none; color: #ffffff;" href="login.php">LOG IN</a>
		</div>
		</div>
							...
							<div>
								<div>
									<div class="signupform_content">
										<?php
										 	if (isset($activacc)){
										 		echo '<h2><a style = "color: #ffffff;" >Activation Form</a></h2>';
										 	}else {
										 		echo '<h2><a style = "color: #ffffff;" > Login Form</a></h2>';
										 	}
										?>
										...
										<div>
											<form action="" method="POST" class="registration">
												<div class="signup_form">
													<?php
														if (isset($activacc)) {
															...
															echo '
																...
																<div>
																	<td>
																		<input name="acemail" placeholder="Enter Your Email" required="required" class="email signupbox" type="email" size="30" value="'.$usernames.'">
																	</td>
																</div>
																<div>
																	<td>
													...
													<div>
														<td>
															<input name="username" placeholder="Enter Your Username" required="required" class="username signupbox" type="username" size="30" value="'.$usernames.'">
														</td>
													</div>
													<div>
														<td>
