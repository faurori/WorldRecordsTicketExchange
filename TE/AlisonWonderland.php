...
<body style="background-color:black;">
	...
	<!--<div style="padding: 30px 120px; font-size: 25px; margin: 0 auto; display: table; width: 98%;"> -->
	    <center><div style="padding: 20px 30px; width: 85%; margin: 0 auto; display: table;"></center>
		<div>
		<?php
			$getposts = mysqli_query($conn,"SELECT * FROM products WHERE SEATCAPACITY >='1' AND ARTIST ='ALISON WONDERLAND'  ORDER BY CONCERTID") or die(mysql_error());
							...
							<ul style="float: left;">
								<li style="float: left; padding: 0px 25px 25px 25px;">
									<div class="home-prodlist-img"><a href="view_product.php?product_id='.$id.'">
										...
										<div style="text-align: center; padding: 0 0 6px 0;"> <span style="font-size: 20px; color: #ffffff;">'.$pName.'<br> '.$venue.'<br> Date: '.$description.'<br> Price: $'.$price.' </span></div>
									</div>
