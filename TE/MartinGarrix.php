...
<body style="background-color:black;">
	...
	<div style="padding: 30px 1 15px; font-size: 25px; margin: 0 auto; display: table; width: 98%;">
		<div><!--DESC LIMIT 50---->
		<?php
			$getposts = mysqli_query($conn,"SELECT * FROM products WHERE SEATCAPACITY >='1' AND ARTIST ='MARTIN GARRIX' ORDER BY CONCERTID ") or die(mysql_error());
							...
							<ul style="float: left;">
								<li style="float: left; padding: 0px 25px 25px 25px;">
									<div class="home-prodlist-img"><a href="view_product.php?product_id='.$id.'">
										...
										<div style="text-align: center; padding: 0 0 6px 0;"> <span style="font-size:  15px; color: #fff;">'.$pName.'<br> '.$venue.'<br> Date: '.$description.'<br> Price: $'.$price.' </span></div>
									</div>
